...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return <div className={`fixed lg:static inset-0 z-40 flex-shrink-0 bg-eon-blue border-r border-eon-dark-blue transition-all duration-300 ${isOpen ? 'w-64' : 'w-0 lg:w-20'}`}>
